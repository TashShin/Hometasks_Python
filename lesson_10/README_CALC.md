...
2. В отчете Allure вы увидите:
   - **Название теста**: "Покупка товаров на SauseDemo".
   - **Описание теста**: Описание, что тест проверяет корректность работы калькулятора с отсрочкой получаемого результата.
   - **Шаги теста**:
     - Открытие браузера.
     - Очистка поля времени и установка заданного ожидания.
